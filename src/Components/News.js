        ...
        return (
            <div className="container my-3">
                <div className="container d-flex justify-content-between">
                    {/* <button disabled={this.state.pade<=1} type="button" className="btn btn-dark" onClick={this.previousclick}>previous</button> */}
                ...
                <div className="row">
                    {this.state.articles.map((element) => {
                        return <div className="col-md-4" key={element.url}>
                            <Newsupdate date={element.publishedAt.slice(0, 10)} title={element.title} newsurl={element.url} imageurl={element.urlToImage} source={element.source.name} />
                        </div>
                    })}
                </div>
                </InfiniteScroll>
